...
//**************************************************************************************
{
    ...
    else if (DumpType == EVILGRAB_PAYLOAD || DumpType == EVILGRAB_DATA)
    {
        if (!TargetPid)
        {
            DoOutputDebugString("SetCapeMetaData: EvilGrab type with no PID - error.\n");
            return FALSE;
        }
        
        if (!hTargetProcess)
        {
            DoOutputDebugString("SetCapeMetaData: EvilGrab type with no process handle - error.\n");
            return FALSE;
        }
...
//**************************************************************************************
{
    ...
    CapeMetaData->DumpType = EVILGRAB_PAYLOAD;
